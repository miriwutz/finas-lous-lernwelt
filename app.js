...
const APP_VERSION = "2.5aj Bäume 12 Prozent größer";
  ...
  forest.forEach((tree, i) => {
    ...
    box.insertAdjacentHTML("beforeend", `
      <article
        ...
        style="left:${layout.left}%; ${forestPositionStyle} --tree-scale:${layout.scale * 1.12}; --tree-tilt:${layout.tilt}deg; --tree-depth:${layout.depth}; z-index:${layout.z};"
        tabindex="0"
