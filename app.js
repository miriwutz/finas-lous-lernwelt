...
const APP_VERSION = "2.3i Wiese & natürliche Krone";
...
const leafPositions = [
  /* links außen */
  [60,212,-34,1],[88,188,145,-1],[111,226,-18,1],[135,199,157,-1],
  [154,238,-41,1],

  /* links mittig */
  [129,158,-24,1],[155,141,151,-1],[177,174,-13,1],[199,151,168,-1],
  [213,206,-31,1],

  /* links oben */
  [184,102,-22,1],[211,119,158,-1],[231,151,-12,1],
  [247,107,-31,1],[262,143,149,-1],

  /* obere Mitte */
  [255,63,-18,1],[283,88,160,-1],[304,124,-7,1],
  [328,57,24,1],[337,101,204,-1],

  /* rechts oben */
  [365,94,26,1],[389,122,212,-1],[412,150,12,1],
  [435,102,31,1],[458,139,206,-1],

  /* rechts außen */
  [402,205,8,1],[431,181,19,1],[458,219,210,-1],
  [485,180,27,1],[507,211,198,-1],

  /* untere, lockere Ergänzungen */
  [94,252,-27,1],[174,262,151,-1],[222,245,-8,1],
  [375,252,9,1],[447,259,201,-1]
];

const rootPaths = [
  "M289 371 C282 392 266 410 244 429 C224 447 205 464 180 478",
  "M290 372 C283 397 273 421 262 448 C256 463 251 479 246 491",
  "M292 371 C290 396 291 423 293 451 C294 469 296 483 299 494",
  "M294 371 C301 395 316 420 336 444 C351 463 369 479 388 487",
  "M288 374 C274 390 253 402 228 410 C202 418 170 421 141 424",
  "M295 374 C310 391 332 402 358 410 C386 418 416 421 445 423",
  "M289 373 C280 398 261 424 243 449 C230 468 218 485 209 499",
  "M294 373 C305 398 323 423 343 448 C359 467 374 484 386 497",
  "M288 374 C273 394 253 411 231 425 C210 438 191 448 173 454",
  "M295 374 C311 394 333 411 357 425 C379 438 400 447 421 453",
  "M290 373 C285 402 279 433 276 463 C275 478 275 489 275 497",
  "M294 373 C300 402 307 432 311 461 C313 476 314 488 314 497"
];
      ...
      >
        <g class="leaf-shape">
          ...
          <path
            ...
            d="M8 -2 C15 -8 23 -11 31 -10"
            stroke="${highlight}"
          />
          <path
            class="leaf-vein"
            d="M4 1 C13 -2 23 -6 33 -11"
          />
          <path
            class="leaf-vein leaf-vein-small"
            d="M13 -2 C12 -6 12 -9 13 -12"
          />
          <path
            class="leaf-vein leaf-vein-small"
            d="M19 -5 C23 -5 27 -4 31 -5"
          />
          <path
            class="leaf-vein leaf-vein-small"
            d="M25 -8 C27 -10 29 -12 30 -14"
          />
        </g>
      </g>
    `);
