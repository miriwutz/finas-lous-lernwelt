...
const APP_VERSION = "2.5ai Bäume 10 Prozent größer";
...
const leafPositions = [
  ...
  /* 51–100: zusätzliche mögliche Blattpositionen – bestehende 1–50 bleiben unverändert */
  [72,190,-62,1],
  [506,188,60,-1],
  [104,102,-42,1],
  [466,100,40,-1],
  ...
  forest.forEach((tree, i) => {
    ...
    box.insertAdjacentHTML("beforeend", `
      <article
        ...
        style="left:${layout.left}%; ${forestPositionStyle} --tree-scale:${layout.scale * 1.10}; --tree-tilt:${layout.tilt}deg; --tree-depth:${layout.depth}; z-index:${layout.z};"
        tabindex="0"
